...
#netbanking payment
driver.get("http://127.0.0.1:8000/payment/cradit/")
...
if r1 or r2 or r3 or r4:
    ...
    driver.get("http://127.0.0.1:8000/payment/cradit/")
    driver.find_element_by_name("cardNumber").send_keys("123456454567")
    driver.find_element_by_name("cvv").send_keys("123")
    driver.find_element_by_name("expiryDate").send_keys("06/25")
