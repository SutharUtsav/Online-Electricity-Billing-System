...
#netbanking payment
driver.get("http://127.0.0.1:8000/payment/mobilebanking/")
...
if r1 or r2 or r3 or r4:
    ...
    driver.get("http://127.0.0.1:8000/payment/mobilebanking/")
    driver.find_element_by_name("mobileNumber").send_keys("9894567534")
    driver.find_element_by_name("ssn").send_keys("123")
    driver.find_element_by_xpath("//input[@type = 'submit' and @value='Pay']").submit()
    url = driver.current_url
    if url == "http://127.0.0.1:8000/payment/mobilebanking/":
